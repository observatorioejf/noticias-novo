                        ...
                        <div class="panel-body">
                            <div class="adv-table">
                                ...
                                <form id="cadastro" name="cadastro" method="POST" onsubmit="return false;"
                                    ...
                                    <br>
                                    <br>
                                    <button id="btnContinuar" style="" type="submit" class="btn btn-default pull-right">
                                        Continuar
                                    </button>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form id="myFormEnviar" method="POST" enctype="multipart/form-data">
                                                <div class="modal-body" style="background-color: #f1f2f7;">
                                                    ...
                                                    <input type="hidden" name="action" value="inserirInterna"/>
                                                </div>
                                ...
                                <div id="modalNoticiaInterna" class="modal fade top-modal-without-space" role="dialog"
                                    ...
                                    <div id="modal-dialog-interna" class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="FuncoesNoticias.php"
                                                  enctype="multipart/form-data">
